...
<head>
    ...
    <style>
        ...
        .surprise-button:hover, .music-button:hover {
...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">
                <span class="highlight">Дорогая тётя Ира! 🎉🎂</span>
                Сегодня твой день, и мы хотим пожелать:  
                <span>🌸 Радости, как весенний рассвет,</span>
                <span>✨ Удачи, как звёзд на небе,</span>
                <span>❤️ Любви, как в сказке!</span>
                Ты для нас самая добрая, милая и прекрасная! 💐  
                Пусть твоя улыбка 🌟 сияет ярче солнца,  
                А каждый новый день дарит счастье и тепло! ☀️  
                <span class="highlight">С Днём Рождения, любимая тётя! 🎁💖</span>
            </p>
        </header>
        ...
        <main>
            ...
            <button class="music-button">🎵 Включить музыку 🎵</button>
